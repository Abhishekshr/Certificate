...
font-size:13px;
  ...
  <script src='js/create_agreement.js'></script>
...
<label for="phone"style="color:#ffffff" >Enter Phone No.</label>
       <input type="number" class="form-control input" id="number"  name="phone"  maxlength = "10"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="phone();" >
</div>
</div>
	   <div class="row">
	   <div class="col-sm-6 bg ">
...
<div>
       ...
       <br>
		...
		<span class="col-6  ">
		<button type="button" class="btn btn-default"  style="padding-right:18px; padding-left:18px; background-color:#88C9C9;height: 40px;" onclick="a= confirm('Are you sure you want to reset the whole form?');if(a){reset();}else{};">Reset
		</button>
		</span>
		<hr style="border-style:solid;width:100%;border-width:1px;border-color:grey"></hr>
		</div>
