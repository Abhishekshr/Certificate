...
font-size:13px;
  ...
  <script src='js/create_appointing.js'></script>
			...
			<!--/down-->
                           ...
                           <div class="menu"  >
							...
							<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Intern Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
									...
									<li id="menu-academico"><a href="name-dropdown.php"><i class="fa fa-file-text-o"></i> <span>Get Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
									<ul id="menu-academico-sub" >
