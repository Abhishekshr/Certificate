...
font-size:13px;
  ...
  <script src='js/create_internship.js'></script>
...
<script>
    $(document).ready(function(){
	  ...
	  var date_input2=$('input[id="working-days-from"]');
	  var date_input3=$('input[id="working-days-to"]');
      ...
      <label for="name" style="color:#ffffff">Enter Branch</label>
	   <select class="form-control form-control-lg a"  id="branch" name="branch" style="height:25px;padding:0%;font-size:15px;" >
          ...
          <option style="font-size:15px; height:25px;" class="dropdown-header" disabled>WEB DEVELOPMENT</option>
		   <option style="font-size:15px;height:25px; " value="01">B.Tech Computer Science</option>
		  ...
		  <option style="font-size:15px;height:25px; " value="41">MBA (Marketing)</option>
		  ...
		  <option style="font-size:15px;height:25px; " value="51">MBA (Marketing)</option>
...
<div class="col-sm-6">
 ...
 <div class="col-sm-6 bg">
    ...
    <input type="text" class="form-control a" value="" id="date-of-printing"  name="date" readonly></div>
	</div>
	<div class="row">	
<div class="col-sm-6 bg"> 
<div class="row">
...
<div class="col-sm-6 bg">
  ...
  font-size:15px;" >none</option>
          <option style="font-size:15px; height:25px;">first</option>
          <option style="font-size:15px;height:25px; ">second</option>
          <option style="font-size:15px;height:25px;">third</option>
        </select>
		</div>
	<div class="col-sm-6 ">
...
<label for="registration_id" class="col-12 col-form-label" style="position:relative; left:-15px; color: #ffffff"  >Registration Id:</label>
    ...
    <input type="text" class="form-control a" value="" id="registration_id"  name="reg_id" readonly></div>
	</div>
<br>
<div>
<input type="hidden" value="Internship_Letter" id="certificate_category">
        ...
        <div class="row" >
        <span class="col-6  ">
        <button type="button" class="btn btn-default" style="background-color:#88C9C9; height: 40px;" onclick="valid();">Submit</button>
		</span>
		<span class="col-6  ">
		<button type="button" class="btn btn-default"  style=" height: 40px; background-color:#88C9C9" onclick="a= confirm('Are you sure you want to reset ? After clicking \'OK\', all your information will be cleared !!'); if(a){reset();} else{};">Reset
		</button>
		</span>
		<hr style="border-style:solid;width:100%;border-width:1px;border-color:grey"></hr>
		</div>
