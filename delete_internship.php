...
<html>
<head>
<title>Wt It Solution Pvt Ltd: Relieving Delete</title>
<meta charset="utf-8">
...
label{
  ...
  <script src="js/delete_internship.js"></script>
...
<img src="wt.png" style=" height: 100px; width: 100px; margin-top: 7%;" class="img-fluid"  ondragstart="return false" >
</div>
...
<h5>Loading...</h5>
 ...
 <div id="result"></div>
  <center>
<form action="/action_page.php"    id="form-element" autocomplete="off" >
    ...
    <h3 style="color:#ffffff" align="left">Delete Record</h3>
     ...
     <div  class="row" style="padding-top: 3%; margin:2%;">
      <div>
       ...
       <div class="col-md-3  col-xs-" align="left">
       ...
       <button type="button" class="btn btn-default input"  style="padding-right:18px; padding-left:18px; background-color:#88F9F9;margin-top: 0px; " id="button1" onclick="valid_delete();">
...
<br>
      ...
      <div class="col-sm-6">
         ...
         <label for="email"  > Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
    ...
    <div class="col-md-6 col-xs-10 bg txt">
      <label for="college"  style="color: #ffffff">College&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
     <label id="college"  style="text-transform:uppercase; color: #FFFE65; "></label>
    </div></div>
</div>
 <div class="form-group "> 
    <div class="row  txt">
      <div class="col-sm-6">
         ...
         <label for="branch"  >Branch&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
      <label id="branch" style="text-transform:uppercase;color: #FFFE65"></label>
      </div>
    ...
    <div class="col-md-6 col-xs-10 bg txt">
      <label for="registration_id"  style="color: #ffffff">Registration ID&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
 ...
 <div class="form-group "> 
    <div class="row  txt">
      <div class="col-sm-6">
         ...
         <label for="branch"  >Training Officer&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
      <label id="training-officer" style="text-transform:uppercase;color: #FFFE65"></label>
      </div>
    ...
    <div class="col-md-6 col-xs-10 bg txt">
      <label for="registration_id"  style="color: #ffffff">Department of Work&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
     <label id="department-of-work"  style="text-transform:uppercase; color: #FFFE65; "></label>
    </div></div>
</div>
...
<footer style="margin-left:-20%; width:137%;" >
  <center><b><b><p style="color:#ffffff; font-size: 15px; ">WT IT SOLUTIONS (P) Ltd</b></b></p>
