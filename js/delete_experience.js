...
$("#position-of-responsibility").html('public relation manager');
}
if($("#new_position_of_responsibility").val()=='7')
{
	
$("#position-of-responsibility").html('public relation officer');
}
if($("#new_position_of_responsibility").val()=='8')
{
	
$("#position-of-responsibility").html('project manager');
}
