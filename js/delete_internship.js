...
$("#department-of-work").html('project manager');
}
...

{
	...
	if($("#hidden_text").val()=="value_email")
       {
...
if($("#hidden_text").val()=="value_phone")
{
	if ($("#search_by").val()=="")
...
$("#department-of-work").html('first');
}
if($("#new_department_of_work").val()=='2')
{
	
$("#department-of-work").html('second');
}
if($("#new_department_of_work").val()=='3')
{
	
$("#department-of-work").html('third');
}
if($("#new_training_officer").val()=='1')
{
