...
.card{
  ...
  <script src='js/search_agreement.js'></script>
...
<div class="form-group"> 
 <div class="row">
  <div class="col-sm-6 bg">
       ...
       <input type="name" class="form-control a" id="name"  name="name" onkeydown="return ((event.keyCode > 64 && event.keyCode < 91) ||  event.keyCode == 8 || event.keyCode == 32)" readonly >
	   </div>
	   <div class="col-sm-6 ">
	<div class="row">
...
<label for="phone"style="color:#ffffff" >Enter Phone No.</label>
	   ...
	   <div class="row">
	   <div class="col-sm-6 bg ">
      <label for="registeration_id" style="margin-top: 8px; color: #fff" >Registration ID</label>
      <input type="text" class="form-control input" id="registeration_id"  name="registration_id" readonly>
    </div>
			...
			<!--/down-->
                           ...
                           <div class="menu">
							...
							<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Intern Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
									...
									<ul id="menu-academico-sub" >
												<li id="menu-academico-avaliacoes" ><a href="php/name-dropdown.php">Generate Certificate</a></li></ul>
