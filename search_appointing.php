...
.card{
  ...
  <script src='js/search_appointing.js'></script>
...
<div id="result"></div>
 ...
 <div style="background:rgba(255,255,255,0.1);padding:10px;"   readonly>
       ...
       <input type="name" class="form-control input" id="name"  name="name"onkeydown="return ((event.keyCode > 64 && event.keyCode < 91) ||  event.keyCode == 8 || event.keyCode == 32)" maxlength=30 readonly>
	   </div>
<br>
<div class="col-sm-6 bg txt col-xs-12">
      <label for="name" style="color:#ffffff"  >Enter address</label>
      <input type="address" class="form-control input" id="address"  name="address" readonly>
	  </div>
	  </div>
	</div>
	<div class="form-group "> 
	  <div class="row  txt">
       ...
       <input type="email" class="form-control input" id="email"  name="email" readonly>
	  	</div>
	  	<div class="col-sm-6 col-xs-12">

	  		 <label for="phone"style="color:#ffffff" >Enter Phone No.</label>
       <input type="number" class="form-control input" id="phone"  name="phone"  maxlength = "10"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="phone();" readonly>
	  	</div>
	  </div>
</div>
...
<div class="row txt">
	...
	<div class="col-sm-6 bg col-xs-12">
	 ...
	 <div class="col-sm-6 bg col-xs-12">
      ...
      <select class="form-control form-control-lg  select" id="place-of-posting" style="height: 26px; padding-top: 1px" name="place-of-posting" disabled>
	     <option selected='selected' hidden value="0">none</option>
...
<div class="col-6 col-md-6 bg col-xs-12">
        ...
        <input class="form-control input" type="time" value="" id="timefrom" name="timefrom" onpaste="return false" readonly>
...
<div  class="col-6 bg col-xs-12" >
	<br>
        ...
        <input class="form-control input" type="time" value="" id="timeto" name="timeto" onpaste="return false"readonly>
</div>
</div>
</div>
 <div class="col-md-6 col-xs-12 ">
