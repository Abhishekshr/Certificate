...
.card{
  ...
  <script src='js/search_experience.js'></script>
...
<br>
      ...
      <input type="email" class="form-control a" id="email"  name="email" readonly >
	  </div>
 ...
 <div class="col-sm-6 bg">
    ...
    <input type="text" class="form-control a" value="" id="duration" name="duration" readonly ></div>
</div></div>
...
<input type=hidden name='experience_certificate' value='experience_certificate' id='experience_certificate'>
     ...
     <input type="salary" class="form-control a" id="salary"  name="salary" readonly onkeydown="return ((event.keyCode > 47 && event.keyCode < 58) ||  (event.keyCode > 95 && event.keyCode < 106)" >
	 </div>
	 <div class="col-sm-6">
...
<label for="registration_id" class="col-12 col-form-label" style="position:relative; left:-15px; color: #ffffff"  >Registration Id:</label>
    ...
    <input type="text" class="form-control a" value="" id="reg_id"  name="reg_id" readonly ></div>
