...
.card{
  ...
  <script src='js/search_internship.js'></script>
...
if(parseInt(getBrowserSize().width) < 800)
{
 ...
 $('#candile').css('margin-left','0px');
    ...
    function is_selected()
   {
      ...
      $("#ab").css("padding","20px"); $("#dynamic").css("color","#ffffff");
...
<div class="form-group"> 
 <div class="row">
      <div class="col-sm-6 bg">
       ...
       <input type="name" readonly class="form-control a" id="name"  name="name" onkeydown="return ((event.keyCode > 64 && event.keyCode < 91) ||  event.keyCode == 8 || event.keyCode == 32)">
...
<div class="col-sm-6 bg">
      ...
      <input type="name" readonly class="form-control a" id="college"   name="college" onkeydown="return ((event.keyCode > 64 && event.keyCode < 91) ||  event.keyCode == 8 || event.keyCode == 32)">
	  </div>
	  <br>
      <div class="col-sm-6 bg">
       <label for="number"style="color:#ffffff" >Enter City</label>
       <input type="name" readonly class="form-control a" id="city"   name="city" onkeydown="return ((event.keyCode > 64 && event.keyCode < 91) ||  event.keyCode == 8 || event.keyCode == 32)" >
	   </div>
<br>
...
<div class="col-sm-6">
       ...
       <input type="number" readonly  class="form-control input" id="phone"  name="phone"  maxlength = "10"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="phone();" >
	  	</div>
 ...
 <div class="col-sm-6 bg">
    ...
    <input type="text" readonly class="form-control a" value="" id="date-of-printing"  name="date" readonly></div>
	</div>
	<div class="row">	
<div class="col-sm-6 bg"> 
<div class="row">
<div class="col-6 bg">
        ...
        <input class="form-control a" type="text" value="" id="working-days-from"  name="from" readonly>
...
<div  class="col-6 bg">
        ...
        <input class="form-control a" type="text" value="" id="working-days-to"  name="to" readonly>
</div></div></div>

	<div class="col-sm-6 bg">
	<br>
	<label for="email" style="color:#ffffff"> Enter Email</label>
      <input type="email" readonly class="form-control a" id="email" name="email" autocomplete="nope"></div>
	  </div></div>
...
<div class="col-sm-6 bg">
        ...
        <select disabled class="form-control form-control-lg a"  id="training-officer" name="training-officer" style="height:25px;
  padding:0%;
  font-size:15px;" >
...
<div class="col-sm-6">
       ...
       <input type="text" readonly class="form-control input" id="registration_id"  name="registration_id" >
	  	</div></div>
...
<footer style="margin-left:-20%; width:137%;">
