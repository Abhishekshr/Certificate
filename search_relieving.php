...
.card{
  ...
  <script src='js/search_relieving.js'></script>
...
<div id="result"></div>
     ...
     <h1 style="color:#ffffff">Relieving Information</h1>
...
<div class="form-group"> 
 <div class="row">
  <div class="col-sm-6 bg">
       ...
       <input type="name" class="form-control a" id="name"  name="name" readonly onkeydown="return ((event.keyCode > 64 && event.keyCode < 91) ||  event.keyCode == 8 || event.keyCode == 32)" >
	   </div>
      <div class="col-sm-6">
	 <label for="date-of-printing" class="col-sm-6 " style="position:relative; left:-12px; color:#ffffff; ">Date of Relieving</label>
...
<div class="col-sm-6 ">
 ...
 <label for="email" style="color:#ffffff; padding-bottom:-2%;"> Enter Email</label>
      <input type="email" class="form-control a" id="email"   name="email" autocomplete="nope" readonly>
</div>
<div class="col-sm-6 ">
<label for="phone"style="color:#ffffff" >Enter Phone No.</label>
       <input type="number" class="form-control input" id="phone"  name="phone" readonly maxlength = "10"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" onkeydown="phone();" >
</div>
</div>
	   <div class="row">
<div class="col-sm-6 ">
...
<div class="col-6 bg">
        ...
        <br>
        	<label style="position:relative; color: #ffffff;" > From:</label>
        
        <input class="form-control a" type="text" value="" id="start" name="start" readonly >
...
<div  class="col-6 bg">
	<br>
        ...
        <input class="form-control a" type="text" value="" id="end" name="end" readonly >
</div>
</div>
</div>
<div class="col-sm-6 bg">

      <label for="registration_id" style="margin-top: 8px; color: #ffffff;padding-top:3.3%;" >Registration ID</label>
      <input type="text" class="form-control input" id="reg_id"  name="registration_id" readonly>
    </div>

</div>
<div>
		<input type="hidden" value="Relieving_Letter" id="certificate_category" >
		</div>
			...
			<!--/down-->
                           ...
                           <div class="menu">
							...
							<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Intern Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
									...
									<ul id="menu-academico-sub" >
												<li id="menu-academico-avaliacoes" ><a href="php/name-dopdown.php">Generate Certificate</a></li>
												</ul>
												</li>
