...
.card{
  ...
  <script src='js/search_salary.js'></script>
...
<div style= "background:rgba(225,225,225,0.1); padding:10px;"  class="container " >
<div id="result"></div>
	 ...
	 <br>
       ...
       <input type="name" class="form-control input" id="name"  name="name" readonly>
	   </div>
<br>
<div class="col-sm-6 bg txt">
      <label for="name" style="color:#ffffff"  >Enter Father's Name</label>
      <input type="name" class="form-control input" id="f_name"  name="f_name" readonly>
	  </div>
	  </div>
	</div>
	<div class="form-group "> 
	  <div class="row  txt">
       ...
       <input type="email" class="form-control input" id="email"  autocomplete='nope' name="email" readonly>
	  	</div>
	  	<div class="col-sm-6">

	  		 <label for="phone" style="color:#ffffff" >Enter Phone No.</label>
       <input type="number" class="form-control input" id="phone"  name="phone"  maxlength = "10"  onkeydown="phone();" readonly >
	  	</div>
	  </div>
</div>
<div class="dropdown-zone row txt">
	<div class="col-sm-6">
      <label for="job-title" style="color:#ffffff; padding-bottom:2%;">Job Title</label>
		 ...
		 <option value='8'>Project Manager Manager</option>
...
<br>
     ...
     <input type="salary" class="form-control input" id="gross_salary"  name="gross_salary" readonly>
	 </div>
	 <div class="col-sm-6">
	 <label for="net_pay" class="col-sm-6 " style="position:relative; left:-12px;color:#ffffff">NET PAY</label>
        <input class="form-control input" type="text"  id="net_pay" name="net_pay" readonly>
        </div>
	   </div>
</div>
<div class="row txt" >
      ...
      <input type="text" class="form-control input" id="reg_id" readonly name="Registeration_id">
    </span>
	 <span class="col-sm-6">
	...
	<br>
	<div>
		<input type="hidden" value="Salary Certification" id="certificate_category" >
		</div>
