...
.card{
  ...
  <script src='js/up_salary.js'></script>
...
<br><br><br><br><br>
<center>
<img src="images/loading.gif" style="height:100px; width:100px;margin-right:40%;">
<br>
<h5>Loading...</h5>
</center>
</div>
...
<div class="dropdown-zone row txt">
    ...
    <input type="text" class="form-control input" value="" id="date1" name="date"  style="margin-bottom: 7px;" ></div>
</div>
...
<div class="row txt" >
      ...
      <input type="text" class="form-control input" id="reg_id"  name="Registeration_id">
    </span>
	 <span class="col-sm-6">
	 <label for="date-of-printing" class="col-sm-6 " style="position:relative;color:#ffffff;left:-12px;">Date of Printing</label>
        <input class="form-control a" type="text" value=""  id="date-of-printing" name="date-of-printing"  >
        </span>
	   </div>
	<br>
	<div>
